...
(function (lt) {
    ...
    (function (Annotations) {
        ...
        (function (UserMedicalPack) {
            var AnnMedicalPack = /** @class */ (function () {
...
(function (lt) {
    ...
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnNorbergDrawer = /** @class */ (function (_super) {
                __extends(AnnNorbergDrawer, _super);
                function AnnNorbergDrawer(automationControl, container, annNorbergObject) {
                    var _this = _super.call(this, automationControl, container, new lt.Annotations.Engine.AnnRectangleObject()) || this;
                    _this._objectTemplate = new lt.Annotations.Engine.AnnRectangleObject();
                    _this._annNorbergObject = null;
                    _this._annNorbergObject = annNorbergObject;
                    _this._objectTemplate = _this.targetObject;
                    _this._objectTemplate.stroke.stroke = lt.Annotations.Engine.AnnSolidColorBrush.create("black");
                    return _this;
                }
...
(function (lt) {
    ...
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnParallelLinesDrawer = /** @class */ (function (_super) {
                ...
                function AnnParallelLinesDrawer(automationControl, container, annParallelLinesObject) {
                    var _this = _super.call(this, automationControl, container, new lt.Annotations.Engine.AnnRectangleObject()) || this;
                    _this._objectTemplate = new lt.Annotations.Engine.AnnRectangleObject();
                    _this._annParallelLinesObject = null;
                    _this._annParallelLinesObject = annParallelLinesObject;
                    _this._objectTemplate = _this.targetObject;
                    _this._objectTemplate.stroke.stroke = lt.Annotations.Engine.AnnSolidColorBrush.create("Blue");
                    return _this;
                }
...
// All Rights Reserved.
// *************************************************************
/// <reference path="./AnnParallelLinesDrawer.ts" />
var lt;
(function (lt) {
    var Annotations;
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnFourParallelLinesDrawer = /** @class */ (function (_super) {
                ...
                function AnnFourParallelLinesDrawer(automationControl, container, annParallelLinesObject) {
                    return _super.call(this, automationControl, container, annParallelLinesObject) || this;
                }
...
(function (lt) {
    ...
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnTwoLinesDrawer = /** @class */ (function (_super) {
                __extends(AnnTwoLinesDrawer, _super);
                function AnnTwoLinesDrawer() {
                    var _this = _super !== null && _super.apply(this, arguments) || this;
                    _this._end = lt.LeadPointD.empty;
                    _this._clickCount = 0;
                    return _this;
                }
                        ...
                        if (!lt.LeadPointD.equals(pt, this._end)) {
                            ...
                            if (this.targetObject.points.count > 1) {
                                if (this._clickCount % 2 != 0) {
                                    this.targetObject.points.item(this.targetObject.points.count - 1, pt); // end point 
                                }
                            }
                ...
                AnnTwoLinesDrawer.prototype.onPointerUp = function (sender, e) {
                    if (this._clickCount > 3) {
                        this.targetObject.points.add(this._end); //we want to add  point at the end to infrom us that drawing finished
                        this.endWorking();
                    }
                    return true;
                };
...
// All Rights Reserved.
// *************************************************************
/// <reference path="./AnnTwoLinesDrawer.ts" />
var lt;
(function (lt) {
    var Annotations;
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnSnapPointDrawer = /** @class */ (function (_super) {
                __extends(AnnSnapPointDrawer, _super);
                function AnnSnapPointDrawer(automationControl, container, annMidlineObject) {
                    return _super.call(this, automationControl, container, annMidlineObject) || this;
                }
...
(function (lt) {
    ...
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnParallelLinesEditor = /** @class */ (function (_super) {
...
(function (lt) {
    ...
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnTwoLinesEditer = /** @class */ (function (_super) {
...
// All Rights Reserved.
// *************************************************************
/// <reference path="./AnnTwoLinesEditor.ts" />
var lt;
(function (lt) {
    var Annotations;
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnSnapPointEditor = /** @class */ (function (_super) {
...
(function (lt) {
    ...
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnCobbAngleData = /** @class */ (function () {
            ...
            var AnnCobbAngleObject = /** @class */ (function (_super) {
                __extends(AnnCobbAngleObject, _super);
                function AnnCobbAngleObject() {
                    var _this = _super.call(this) || this;
                    _this._cobbAngleData = new AnnCobbAngleData();
                    _this._anglePrecision = 2;
                    _super.prototype.setId.call(_this, -1007);
                    _this.labels["CobbAngle"] = new lt.Annotations.Engine.AnnLabel();
                    _this.fixedStateOperations = lt.Annotations.Engine.AnnFixedStateOperations.lengthValue | lt.Annotations.Engine.AnnFixedStateOperations.fontSize;
                ...
                AnnCobbAngleObject.prototype.hitTest = function (point, hitTestBuffer) {
                    ...
                    if (hit) {
                        ...
                        hit = false;
                        var pointsCount = parseInt((this.points.count / 2).toString()); // pointsCount should be integer so we do the cast
...
(function (lt) {
    ...
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnIntersectionPointObject = /** @class */ (function (_super) {
                __extends(AnnIntersectionPointObject, _super);
                function AnnIntersectionPointObject() {
                    var _this = _super.call(this) || this;
                    _this._intersectionInsideContainer = false;
                    _this._intersectionPoint = lt.LeadPointD.empty;
                    _this._intersectionPointRadius = lt.LeadLengthD.create(30);
                    _super.prototype.setId.call(_this, -1006);
                    //registerclass to annotation.Core for allowing it to get class Full Name 
...
(function (lt) {
    ...
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnMidlineObject = /** @class */ (function (_super) {
                __extends(AnnMidlineObject, _super);
                function AnnMidlineObject() {
                    var _this = _super.call(this) || this;
                    _this._centerPointRadius = lt.LeadLengthD.create(30);
                    _super.prototype.setId.call(_this, -1004);
                    //registerclass to annotation.Core for allowing it to get class Full Name 
...
(function (lt) {
    ...
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnNorbergObject = /** @class */ (function (_super) {
                __extends(AnnNorbergObject, _super);
                function AnnNorbergObject() {
                    var _this = _super.call(this) || this;
                    _super.prototype.setId.call(_this, -1008);
                    _this.labels["FirstAngle"] = new lt.Annotations.Engine.AnnLabel();
                    _this.labels["SecondAngle"] = new lt.Annotations.Engine.AnnLabel();
                    _this.labels["AngleText"].background = lt.Annotations.Engine.AnnSolidColorBrush.create("white");
                    _this.labels["AngleText"].foreground = lt.Annotations.Engine.AnnSolidColorBrush.create("blue");
                    _this.showTickMarks = false;
                    _this.labels["FirstRulerLength"].isVisible = false;
                    _this.labels["SecondRulerLength"].isVisible = false;
                    // Register "AnnNorbergObject" class to lt.Annotation.Core
...
(function (lt) {
    ...
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnParallelLinesObject = /** @class */ (function (_super) {
                __extends(AnnParallelLinesObject, _super);
                function AnnParallelLinesObject() {
                    var _this = _super.call(this) || this;
                    _super.prototype.setId.call(_this, -1001);
                    //registerclass to annotation.Core for allowing it to get class Full Name 
...
(function (lt) {
    ...
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnNorbergObjectRenderer = /** @class */ (function (_super) {
...
(function (lt) {
    ...
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnParallelLinesObjectRenderer = /** @class */ (function (_super) {
...
(function (lt) {
    ...
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnTwoLinesObjectRenderer = /** @class */ (function (_super) {
                ...
                AnnTwoLinesObjectRenderer.prototype.render = function (mapper, annObject) {
                    ...
                    if (engine != null && engine.context != null) {
                        ...
                        var linesCount = parseInt((leadPoints.length / 2).toString()); // linesCount should be integer so we do the cast
                        if (linesCount > 0) {
...
(function (lt) {
    ...
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnMidlineObjectRenderer = /** @class */ (function (_super) {
                        ...
                        if (annMidlineObject != null) {
                            ...
                            if (linesCount > 0) {
                                ...
                                for (var i = 0; i < linesCount; ++i) {
                                    ...
                                    this.doDrawPoint(annMidlineObject, engine.context, center, radius);
                                ...
                                if (linesCount > 1) {
                                    ...
                                    for (var i = 0; i < count; ++i) {
                                        engine.context.beginPath();
                                        this.doDrawLine(engine.context, linesCenters[i], linesCenters[i + 1]);
                                        if (annObject.supportsStroke && annObject.stroke != null) {
                ...
                AnnMidlineObjectRenderer.prototype.doDrawLine = function (context, firstPoint, secondPoint) {
                    context.moveTo(firstPoint.x, firstPoint.y);
                    context.lineTo(secondPoint.x, secondPoint.y);
                };
                AnnMidlineObjectRenderer.prototype.doDrawPoint = function (annObject, context, point, radius) {
                    ...
                    this.doDrawLine(context, topLeft, bottomRight);
                    this.doDrawLine(context, bottomLeft, topRight);
                    this.doDrawLine(context, lt.LeadPointD.create(point.x, point.y - pointBounds.width / 2), lt.LeadPointD.create(point.x, point.y + pointBounds.width / 2));
                    this.doDrawLine(context, lt.LeadPointD.create(point.x - pointBounds.width / 2, point.y), lt.LeadPointD.create(point.x + pointBounds.width / 2, point.y));
...
(function (lt) {
    ...
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnIntersectionObjectRenderer = /** @class */ (function (_super) {
                    ...
                    if (engine != null && engine.context != null) {
                        ...
                        if (UserMedicalPack.AnnIntersectionPointObject.isInstanceOfType(annObject)) {
                            ...
                            if (points.length > 2) {
                                ...
                                this.doDrawPoint(annIntersectionPointObject, engine.context, intersectionPoint, radius);
                                if (points.length < 5 && annIntersectionPointObject.intersectionInsideContainer) {
                                    engine.context.beginPath();
                                    this.doDrawLine(engine.context, points[3], intersectionPoint);
                                    if (annObject.supportsStroke && annObject.stroke != null) {
                ...
                AnnIntersectionObjectRenderer.prototype.doDrawPoint = function (annObject, context, point, radius) {
                    var pointBounds = lt.LeadRectD.create(point.x - radius, point.y - radius, radius * 2, radius * 2);
                    var topLeft = pointBounds.topLeft;
                    var topRight = pointBounds.topRight;
                    var bottomLeft = pointBounds.bottomLeft;
                ...
                AnnIntersectionObjectRenderer.prototype.doDrawLine = function (context, firstPoint, secondPoint) {
                    context.moveTo(firstPoint.x, firstPoint.y);
                    context.lineTo(secondPoint.x, secondPoint.y);
                };
...
// All Rights Reserved.
// *************************************************************
/// <reference path="./AnnTwoLinesObjectRenderer.ts" />
var lt;
(function (lt) {
    var Annotations;
    (function (Annotations) {
        var UserMedicalPack;
        (function (UserMedicalPack) {
            var AnnCobbAngleObjectRenderer = /** @class */ (function (_super) {
                    ...
                    if (engine != null && engine.context != null) {
                        ...
                        if (annCobbAngleObject != null) {
                            ...
                            if (points.length > 3) {
                                ...
                                engine.context.save();
                                engine.context.beginPath();
                                this.doDrawLine(engine.context, firstPoint, intersectionPoint);
                                this.doDrawLine(engine.context, secondPoint, intersectionPoint);
                                if (annObject.supportsStroke && annObject.stroke != null) {
                                    var stroke = lt.Annotations.Engine.AnnStroke.create(lt.Annotations.Engine.AnnSolidColorBrush.create("Blue"), annObject.stroke.strokeThickness);
                                    lt.Annotations.Rendering.AnnHtml5RenderingEngine.setStrokeWithOpacity(engine.context, stroke, annObject.opacity);
                                    engine.context.stroke();
                ...
                AnnCobbAngleObjectRenderer.prototype.doDrawLine = function (context, firstPoint, secondPoint) {
                    context.moveTo(firstPoint.x, firstPoint.y);
                    context.lineTo(secondPoint.x, secondPoint.y);
                };
                AnnCobbAngleObjectRenderer.prototype.getAngleText = function (angle, precision) {
                    //here we will use precision to determine the number of floating digits
