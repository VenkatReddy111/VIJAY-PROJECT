    ...
    (function (Annotations) {
        ...
        (function (JavaScript) {
            var AnnPropertyInfo = /** @class */ (function () {
                function AnnPropertyInfo(propertyName, readOnly, value, category, description, displayName, visible, editorType /*Type*/) {
                    var _this = this;
...
(function (lt) {
    ...
    (function (Annotations) {
        ...
        (function (JavaScript) {
            var AutomationUpdateObjectDialog = /** @class */ (function () {
                function AutomationUpdateObjectDialog() {
                    ...
                    this.generateDialogTabs = function () {
                        ...
                        if (_this._tabVisible[AutomationUpdateObjectDlgTab.Content]) {
                            // Set the content tab as active , if the properties tab is hidden
            ...
            var AutomationUpdateObjectDlgTab;
            ...
            })(AutomationUpdateObjectDlgTab = JavaScript.AutomationUpdateObjectDlgTab || (JavaScript.AutomationUpdateObjectDlgTab = {}));
        })(JavaScript = Annotations.JavaScript || (Annotations.JavaScript = {}));
    })(Annotations = lt.Annotations || (lt.Annotations = {}));
})(lt || (lt = {}));
var lt;
            ...
            var ContentPage = /** @class */ (function () {
                function ContentPage() {
                    ...
                    this.createUIElement = function () {
                        //creates the html output from Object Content
                        var htmlOut = "";
                ...
                AutomationObjectsListControl.prototype.populateContainer = function (annContainer) {
                    ...
                    if (pageNode) {
                        ...
                        if (annContainer.children.count > 0) {
                            ...
                            if (pageAfter) {
                                // Insert befor the first founded page
        ...
        (function (JavaScript) {
            var PageTreeNode = /** @class */ (function (_super) {
                ...
                function PageTreeNode(owner, automation, imageViewer, annContainer) {
                    ...
                    _this.headingLabel.textContent = "Page " + annContainer.pageNumber;
                    return _this;
                }
...
(function (lt) {
    ...
    (function (Annotations) {
        ...
        (function (JavaScript) {
            ...
            var AnnColorEditor = /** @class */ (function () {
            ...
            var AnnBooleanEditor = /** @class */ (function () {
            ...
            var AnnLengthEditor = /** @class */ (function () {
            ...
            var AnnSolidColorBrushEditor = /** @class */ (function () {
            ...
            var AnnDoubleEditor = /** @class */ (function () {
            ...
            var AnnStringEditor = /** @class */ (function () {
            ...
            var AnnPictureEditor = /** @class */ (function () {
                function AnnPictureEditor(value, category) {
                    this._properties = null;
                    this._value = lt.Annotations.Engine.AnnPicture.empty;
                    this._category = category;
                    this.value = value;
                }
            ...
            var AnnMediaEditor = /** @class */ (function () {
                function AnnMediaEditor(value, category) {
                    this._properties = null;
                    this._value = new lt.Annotations.Engine.AnnMedia();
                    this._category = category;
                    this.value = value;
                }
            ...
            var AnnIntegerEditor = /** @class */ (function () {
            ...
            var AnnStrokeEditor = /** @class */ (function () {
            ...
            var AnnFontEditor = /** @class */ (function () {
                ...
                function AnnObjectEditor(annObject) {
                        ...
                        if (newValue != null) {
                            if (_this._annObject != null) {
                                if (lt.Annotations.Engine.AnnHiliteObject.isInstanceOfType(_this._annObject)) {
                                    ...
                                    _this._annObject.set_fill(lt.Annotations.Engine.AnnSolidColorBrush.create(newValue));
                                }
                            }
                        }
                    };
                    ...
                    this.ruberStampTypeinfo_ValueChanged = function (oldValue, newValue) {
                        if (lt.Annotations.Engine.AnnRubberStampObject.isInstanceOfType(_this._annObject)) {
                            ...
                            annRubberStampObject.set_rubberStampType(lt.Annotations.Engine.Utils.enumParse(lt.Annotations.Engine.AnnRubberStampType, "Stamp" + _this.properties["RuberStampType"].values[newValue]));
                        }
                    ...
                    this.angularUnitInfo_ValueChanged = function (oldValue, newValue) {
                        if (lt.Annotations.Engine.AnnProtractorObject.isInstanceOfType(_this._annObject)) {
                            var annProtractorObject = _this._annObject;
                            annProtractorObject.set_angularUnit(lt.Annotations.Engine.Utils.enumParse(lt.Annotations.Engine.AnnAngularUnit, _this.properties["AngularUnit"].values[newValue]));
                        }
                    };
                    ...
                    this.measurementUnitInfo_ValueChanged = function (oldValue, newValue) {
                        if (lt.Annotations.Engine.AnnPolyRulerObject.isInstanceOfType(_this._annObject)) {
                            var annPolyRulerObject = _this._annObject;
                            annPolyRulerObject.set_measurementUnit(lt.Annotations.Engine.Utils.enumParse(lt.Annotations.Engine.AnnUnit, _this.properties["MeasurementUnit"].values[newValue]));
                        }
                    };
                    ...
                    this.horizontalAlignment_ValueChanged = function (oldValue, newValue) {
                        if (lt.Annotations.Engine.AnnTextObject.isInstanceOfType(_this._annObject)) {
                            var annTextObject = _this._annObject;
                            annTextObject.set_horizontalAlignment(lt.Annotations.Engine.Utils.enumParse(lt.Annotations.Engine.AnnHorizontalAlignment, _this.properties["HorizontalAlignment"].values[newValue]));
                        }
                    };
                    this.verticalAlignment_ValueChanged = function (oldValue, newValue) {
                        if (lt.Annotations.Engine.AnnTextObject.isInstanceOfType(_this._annObject)) {
                            var annTextObject = _this._annObject;
                            annTextObject.set_verticalAlignment(lt.Annotations.Engine.Utils.enumParse(lt.Annotations.Engine.AnnVerticalAlignment, _this.properties["VerticalAlignment"].values[newValue]));
                        }
                    };
                    ...
                    if (annObject.get_supportsFill() && !(lt.Annotations.Engine.AnnHotspotObject.isInstanceOfType(annObject))) {
                        var fill = null;
                        if (lt.Annotations.Engine.AnnHiliteObject.isInstanceOfType(annObject)) {
                            var annHiliteObject = annObject;
                            fill = lt.Annotations.Engine.AnnSolidColorBrush.create(annHiliteObject.get_hiliteColor());
                            ...
                            if (fill == null) {
                                annObject.set_fill(lt.Annotations.Engine.AnnSolidColorBrush.create("Transparent"));
                                fill = annObject.get_fill();
                            }
                    ...
                    if (annObject.get_supportsStroke() && !(lt.Annotations.Engine.AnnHotspotObject.isInstanceOfType(annObject))) {
                    ...
                    if (lt.Annotations.Engine.AnnPolyRulerObject.isInstanceOfType(annObject) && this._annObject.id != norbergObjectId) {
                        ...
                        var measurementUnit = lt.Annotations.Engine.Utils.enumToString(lt.Annotations.Engine.AnnUnit, annPolyRulerObject.get_measurementUnit());
                    ...
                    if (lt.Annotations.Engine.AnnProtractorObject.isInstanceOfType(annObject)) {
                        ...
                        var angulartUnit = lt.Annotations.Engine.Utils.enumToString(lt.Annotations.Engine.AnnAngularUnit, annProtractorObject.get_angularUnit());
                    ...
                    if (lt.Annotations.Engine.AnnRubberStampObject.isInstanceOfType(annObject)) {
                        ...
                        var rubberStamp = lt.Annotations.Engine.Utils.enumToString(lt.Annotations.Engine.AnnRubberStampType, annRubberStampObject.get_rubberStampType());
                    ...
                    if (lt.Annotations.Engine.AnnTextObject.isInstanceOfType(annObject)) {
                        ...
                        var vertical = lt.Annotations.Engine.Utils.enumToString(lt.Annotations.Engine.AnnVerticalAlignment, annTextObject.get_verticalAlignment());
                        ...
                        var horizontal = lt.Annotations.Engine.Utils.enumToString(lt.Annotations.Engine.AnnHorizontalAlignment, annTextObject.get_horizontalAlignment());
                    ...
                    if (annObject.get_id() == lt.Annotations.Engine.AnnObject.mediaObjectId || annObject.get_id() == lt.Annotations.Engine.AnnObject.audioObjectId) {
                    ...
                    if (annObject.get_id() == lt.Annotations.Engine.AnnObject.encryptObjectId) {
        ...
        (function (JavaScript) {
            var ObjectsAlignmentDialog = /** @class */ (function () {
                ...
                ObjectsAlignmentDialog.prototype.show = function () {
                    ...
                    // update objectsAlignmentBtns state
                ...
                function PropertiesPage() {
                    ...
                    this.editObject = function (annObject) {
                        ...
                        if (annObject != null) {
                            ...
                            if (annObject.id == lt.Annotations.Engine.AnnObject.selectObjectId) {
                                ...
                                for (var i = 0; i < selection.selectedObjects.count; i++) {
                                    ...
                                    if (selection.selectedObjects.item(i).get_id() == lt.Annotations.Engine.AnnObject.mediaObjectId || selection.selectedObjects.item(i).get_id() == lt.Annotations.Engine.AnnObject.audioObjectId) {
                    ...
                    switch (type) {
                        ...
                        case 'picture':
                            ...
                            var label = "<div data-role=\"fieldcontain\">" +
                                ...
                                "<input class='form-control' style=\"text-align:center;\"id=\"" + inputId + "\" onchange=\"Javascript:lt.Annotations.JavaScript.PropertiesPage.UpdateStyleInner('" + cssId + "','" + inputId + "', String.isNullOrEmpty(this.value) ? null : new lt.Annotations.Engine.AnnPicture(this.value));\" value=\"" + source + "\"></input>" +
                                "</div>";
                            return label;
                        case 'media':
                            var inputId = outputDivId;
            ...
            var ReviewsPage = /** @class */ (function () {
                ...
                ReviewsPage.prototype.updateContent = function (annObject) {
                    ...
                    if (metadata[lt.Annotations.Engine.AnnObject.modifiedMetadataKey] != undefined || metadata[lt.Annotations.Engine.AnnObject.modifiedMetadataKey] != null) //if Contains
                        lastModified = JavaScript.AnnObjectTreeNode.toLocalTimeString(metadata[lt.Annotations.Engine.AnnObject.modifiedMetadataKey]);
                    if (!lastModified)
                        lastModified = "[date]";
                    $("#" + this.pageUI.header).text("By " + author + " at " + lastModified);
                    var text = "";
                    if (lt.Annotations.Engine.AnnTextObject.isInstanceOfType(annObject)) {
                ...
                ReviewsPage.prototype.reviewToDetails = function () {
                    ...
                    $("#" + this.pageUI.month).val((date.getMonth() + 1).toString()); //month zero based
        ...
        (function (JavaScript) {
            var SnapToGridPropertiesDialog = /** @class */ (function () {
                ...
                SnapToGridPropertiesDialog.prototype.okBtn_Click = function (e) {
                    ...
                    this._snapToGridOptions.gridStroke.stroke = lt.Annotations.Engine.AnnSolidColorBrush.create(gridColorComboBox.value.toString());
        ...
        (function (JavaScript) {
            ...
            var AutomationImageViewer = /** @class */ (function (_super) {
                ...
                function AutomationImageViewer(createOptions) {
                    ...
                    _this.get_interactiveService().add_tap(_this.handleGotFocus);
                    return _this;
                }
...
(function (lt) {
    ...
    (function (Annotations) {
        ...
        (function (JavaScript) {
            ...
            var RightClickInteractiveMode = /** @class */ (function (_super) {
                ...
                function RightClickInteractiveMode() {
                    ...
                    _this.RightClickInteractiveMode_ServiceTap = function (sender, e) {
                        if (_this._automation == null)
                            return;
                        if (!_this.canStartWork(e)) {
                            return;
                        }
                        if (_this._automation.manager.userMode === lt.Annotations.Engine.AnnUserMode.run) {
                            return;
                        }
                        ...
                        if (currentDesigner != null && (currentDesigner instanceof lt.Annotations.Designers.AnnDrawDesigner)) {
                            // End the current designer. Don't show the context menu, just return
                            ...
                            // Dont show the menu, just return
                            return;
                        }
                        if (_this.onRightClick != null) {
                            //Fire OnRightClick Event
